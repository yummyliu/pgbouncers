...
/* Define to 1 if you have the `asn1_time_parse' function. */
/* #undef HAVE_ASN1_TIME_PARSE */
...
#define PACKAGE_STRING "pgbouncer 1.8.1"
...
/* Define to max win32 API version (0x0600=Vista). */
/* #undef WINVER */
