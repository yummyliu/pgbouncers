#!/bin/sh
# learning from https://github.com/brainsam/pgbouncer/blob/master/entrypoint.sh
...
if [ ! -f ${PGB_CONFIG_DIR}/pgbouncer.ini ]; then
  echo "create pgbouncer config in ${PGB_CONFIG_DIR}"
...
if [ -z $QUIET ]; then
  cat ${PGB_CONFIG_DIR}/pgbouncer.ini
fi
echo "Starting pgbouncer..."
exec /bin/pgbouncer ${QUIET:+-q} -u ${PGB_USER} ${PGB_CONFIG_DIR}/pgbouncer.ini
